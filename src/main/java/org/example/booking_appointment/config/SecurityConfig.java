package org.example.booking_appointment.config;

import lombok.AllArgsConstructor;
import org.example.booking_appointment.filters.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.sessionManagement(c ->
                ...
                .authorizeHttpRequests(c -> c
                        ...
                        .requestMatchers(HttpMethod.POST, "/rooms/search-available").permitAll()
